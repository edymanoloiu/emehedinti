...
const ContactPage = () => {
	...
	return (
		<>
			<HeadMeta metaTitle="Politica de Confidențialitate" metaDesc={"Politica de confidențialitate pentru site-ul emehedinti.ro"} />
			<HeaderOne />
				...
				<div className="row">
					<div className="col-lg-8">
						<div className="axil-content">
							...
							<p>
								Operatorul datelor cu caracter personal este <strong>Weboratory Capital SRL</strong>, Otopeni, România, e-mail: <a href="mailto:contact@weboratory.ro">contact@weboratory.ro</a>. Prelucrăm datele dvs. în conformitate cu Regulamentul (UE) 2016/679 (GDPR).
							</p>
							...
							<ul>
								...
								<li>dreptul de a formula plângere la <strong>ANSPDCP</strong> (Autoritatea Națională de Supraveghere a Prelucrării Datelor cu Caracter Personal), B-dul G-ral. Gheorghe Magheru 28-30, Sector 1, 010336 București, e-mail: <a href="mailto:anspdcp@dataprotection.ro">anspdcp@dataprotection.ro</a>, <a href="https://www.dataprotection.ro" target="_blank" rel="noopener noreferrer">www.dataprotection.ro</a>.</li>
							</ul>
							<p>
								Pentru exercitarea drepturilor, ne puteți scrie la <a href="mailto:contact@weboratory.ro">contact@weboratory.ro</a>.
							</p>
