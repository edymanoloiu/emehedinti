# SEO changes implemented — emehedinti
...
7. **robots.txt**
   - Trailing-slash Disallow paths; production sitemap URLs for emehedinti.ro.
...
- **Articles:** `https://emehedinti.ro/post/{slug}/`
- **Promo:** `https://emehedinti.ro/recomandare/{slug}/`
- **Categories:** `https://emehedinti.ro/categorie/{category-slug}/`
