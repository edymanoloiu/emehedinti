...
const ContactPage = () => {
	...
	return (
		<>
			<HeadMeta metaTitle="Termeni și Condiții" metaDesc={"Termenii și condițiile de utilizare pentru site-ul emehedinti.ro"} />
			<HeaderOne />
				...
				<div className="row">
					<div className="col-lg-8">
						<div className="axil-content">
							...
							<p>
								Acest site este operat de <strong>Weboratory Capital SRL</strong>, cu sediul în Otopeni, România. CUI: 43276159. E-mail: <a href="mailto:contact@weboratory.ro">contact@weboratory.ro</a>Publicația face parte din rețeaua media <strong>Weboratory Capital</strong>.
							</p>
							<h2>1. Scopul site-ului</h2>
							<p>
								Site-ul <strong>emehedinti.ro</strong> este o publicație online destinată informării publicului prin știri, articole și materiale editoriale. Toate informațiile sunt furnizate în scop informativ.
							</p>
							...
							<p>
								...
								vă rugăm să ne contactați la <a href="mailto:contact@weboratory.ro">contact@weboratory.ro</a>
