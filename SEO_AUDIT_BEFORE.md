# SEO Audit — emehedinti (before changes)

**Date:** 2026-07-31  
**Branch base:** `main`  
**Domain:** https://emehedinti.ro  
...
- **Why:** Links every article to the same newest set; button points at `/categorie/stiri-generale` which may not match real categories (`Azi in Drobeta-Turnu Severin`).
...
- **Why:** Wrong category constants for Drobeta-Turnu Severin; feeds incorrect section mapping.
- **Proposed fix:** Drobeta-Turnu Severin-aware or retire section routing in favor of `/post/`.
- **Safe to automate:** Yes
...
- Publication config has real domain `https://emehedinti.ro`
