      ...
      <div className="post-navigation-wrapper post-navigation__banner">
        <div className="post-navigation">
          <div className="post-nav-content">
			<span className="prev-post" aria-disabled="true">
        ...
        <div className="post-navigation">
          <div className="post-nav-content">
		  	<span className="next-post" aria-disabled="true">
				Next Post
          ...
          <div className="col-lg-8">
            <div className="post-title-wrapper">
              <div className="btn-group">
			  		<Link href={`/categorie/${slugify(metaData.cate)}`} className={`cat-btn ${metaData.cate_bg ?? "bg-color-blue-one"}`}>{metaData.cate}</Link>
              </div>
              ...
              <div className="post-metas banner-post-metas m-t-xs-20">
                <ul className="list-inline">
                  <li>
				  	<Link href={`/autor/${slugify(metaData.author_name)}`} className="post-author post-author-with-img">
							<Image
