...
const ContactPage = () => {
	...
	return (
		<>
			<HeadMeta metaTitle="Politica de Cookies" metaDesc={"Politica de Cookies pentru site-ul emehedinti.ro"} />
			<HeaderOne />
				...
				<div className="row">
					<div className="col-lg-8">
						<div className="axil-content">
							...
							<p>
								La prima vizită pe site-ul <strong>emehedinti.ro</strong>, vi se va afișa o fereastră/bara de informare privind cookie-urile. Puteți accepta toate cookie-urile sau vă puteți personaliza preferințele.
							</p>
